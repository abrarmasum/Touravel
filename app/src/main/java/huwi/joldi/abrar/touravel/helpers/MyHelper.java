package huwi.joldi.abrar.touravel.helpers;
...
import huwi.joldi.abrar.touravel.R;
...
public class MyHelper {
	...
	public static File createTempFile(File file) {
		File dir = new File(Environment.getExternalStorageDirectory().getPath() + "/huwi.joldi.abrar.mlkit");
